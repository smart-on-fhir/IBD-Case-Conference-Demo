...
function renderPopulationHeader(data) {
    ...
    data.tableRows.forEach(row => {
        $(
            `<tr>
                <td class="text-start text-success fw-semibold bg-pale-blue">${row[1]}</td>
                ...
                <td class="text-start text-muted px-2 bg-pale-blue" style="width:5em"><span class="badge bg-success d-block">${row[3].boxplot.data[2]}</span></td>
            </tr>`
        ).appendTo($tbody)
    })
}
